...
#Bit.ly alpha script.3: Asks for input, assign input to answer variable. Use list() to separate the string in each of its conforming letters. If input contains spaces, abort. Else print list check
